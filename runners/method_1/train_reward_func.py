...
def main():
    ...
    from method_1.reward_func.trainer import Reward_Func_Trainer
    trainer = Reward_Func_Trainer(cfg, training_attr_data=attr_training_data,
                                  eval_attr_data=attr_test_data,
